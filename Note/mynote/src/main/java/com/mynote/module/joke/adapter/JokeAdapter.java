...
public class JokeAdapter extends MyAdapter<JokeBean> {
    private String searchInfo;
    private boolean isEdit;
    public JokeAdapter(Context mContext, int layoutId, int pageSize) {
        super(mContext, layoutId, pageSize);
    }

    public JokeAdapter(Context mContext, int layoutId, int pageSize, NestedScrollView nestedScrollView) {
