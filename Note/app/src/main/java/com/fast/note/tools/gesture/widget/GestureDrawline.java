package com.fast.note.tools.gesture.widget;
...
import com.fast.note.tools.gesture.common.AppUtil;
import com.fast.note.tools.gesture.common.Constants;
import com.fast.note.tools.gesture.entity.GesturePoint;
...
//		paint.setColor(Color.rgb(245, 142, 33));// 设置默认连线颜色
		paint.setColor(getResources().getColor(R.color.blue_point));// 设置默认连线颜色
...
//		paint.setColor(Color.rgb(154, 7, 21));// 设置默认线路颜色
		paint.setColor(getResources().getColor(R.color.red_point));// 设置默认线路颜色
		for (Pair<GesturePoint, GesturePoint> pair : lineList) {
